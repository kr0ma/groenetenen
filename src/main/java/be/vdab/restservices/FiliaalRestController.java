...
public class FiliaalRestController {
	...
	/*
	 * @RequestMapping(path = "{filiaal}", method = RequestMethod.GET) Filiaal
	 * read(@PathVariable Filiaal filiaal) { if (filiaal == null) { throw new
	 * FiliaalNietGevondenException(); } return filiaal; }
	 */
